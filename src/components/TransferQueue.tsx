...
import { ChevronDown, ChevronUp, Clock, CheckCircle2, XCircle, FileIcon, FolderIcon, Link } from 'lucide-react';
...
export interface QueuedTransfer {
  ...
  size: number;
  progress: number;
  status: 'pending' | 'processing' | 'completed' | 'failed' | 'awaiting-approval';
